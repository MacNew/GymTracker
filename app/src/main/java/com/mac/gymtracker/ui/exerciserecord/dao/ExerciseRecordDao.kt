...
interface ExerciseRecordDao {
    ...
    @Query("select  date, exercise_name, weight, reps, `Set`, save_time, main_exercise, roomDate, string_format_date, time_in_second, rest_time_in_second from exercise_record")
