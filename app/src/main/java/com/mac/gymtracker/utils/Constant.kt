...
private fun loadExercisList(context: Context) {
    ...
    list.addExercise(
        ...
        R.drawable.ic_seated_dumbbell_press.toString(),
        SHOULDER_ID
    )
    list.addExercise(
        "Seated Barbell Press",
        R.drawable.ic_seated_barbell_press.toString(),
        SHOULDER_ID
    )
    ...
    list.addExercise(
        ...
        R.drawable.ic_machine_pump_shoulder.toString(),
        SHOULDER_ID
    )
    list.addExercise(
        "Heavy Shoulder workout",
        R.drawable.ic_heard_and_heavy_shoulder_workout.toString(),
        SHOULDER_ID
    )
    ...
    list.addExercise(
        ...
        R.drawable.ic_machine_pump_leg_workout.toString(),
        LEG_ID
    )
    list.addExercise("Beginner Leg Workout", R.drawable.ic_beginner_leg_work_out.toString(), LEG_ID)
    list.addExercise(
        "Incline Dumbbell Hammer Curl",
        R.drawable.ic_incline_dumbbell_hammer_curl.toString(),
        BICEPS_ID
    )
    list.addExercise(
        "Incline Inner-Biceps Curl",
        R.drawable.ic_incline_inner_biceps_curl.toString(),
        BICEPS_ID
    )
    list.addExercise("EZ-Bar Curl", R.drawable.ic_ez_bar_curl.toString(), BICEPS_ID)
    list.addExercise(
        "Wide-Grip Standing Barbell Curl",
        R.drawable.ic_wide_grip_standing_barbell_curl.toString(),
        BICEPS_ID
    )
    ...
    list.addExercise(
        ...
        R.drawable.ic_dumbbell_biceps_curl.toString(),
        BICEPS_ID
    )
    ...
    list.addExercise(
        ...
        R.drawable.ic_close_grip_bench_press.toString(),
        TRICEPS_ID
    )
    ...
    list.addExercise(
        "Triceps Machine Dip",
        R.drawable.ic_triceps_machine_dip.toString(),
        TRICEPS_ID
    )
    list.addExercise(
        "Dumbbell Overhead Triceps Extension",
        R.drawable.ic_dumbbell_overhead_triceps_extenstion.toString(),
        TRICEPS_ID
    )
    list.addExercise(
        "Cable Overhead Extension with Rope",
        R.drawable.ic_cable_overhead_extension_with_rope.toString(),
        TRICEPS_ID
    )
    list.addExercise(
        "Single-Arm Cable kick-back",
        R.drawable.ic_single_arm_cable_kick_back.toString(),
        TRICEPS_ID
    )
